--元宝票
--2019-10-29 17:38:32 逍遥子
---===================================================
x900001_g_scriptId = 900001
x900001_g_GiftItem = 38002409
x900001_g_Item = {
	[38000641] = 20000000,
}
--**********************************
...
function x900001_OnConditionCheck( sceneId, selfId )
	...
	if x900001_g_Item[itemTblIndex] == nil then
		x900001_Tip(sceneId,selfId,"物品非法");
		return 0 
	end
...
function x900001_OnActivateOnce( sceneId, selfId )
	...
	AddExpMore(sceneId,selfId,x900001_g_Item[Itemid])
	-- x900001_Tip(sceneId,selfId,format("获得了%s经验！",x900001_g_Item[Itemid]))
	return 1
end
...
function x900001_Tip( sceneId,selfId,Tip )
	BeginEvent( sceneId )
	AddText( sceneId, Tip )
	EndEvent( sceneId )
