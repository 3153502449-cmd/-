--融魂丹
--build 2019-7-28 21:25:48 逍遥子
--脚本号
x889822_g_scriptId = 889822
x889822_g_Huanse_PetPossList = {
	[30503183] = 2,	--附体：游龙
	[30503184] = 3,	--附体：幻蝶
	[30503185] = 4,	--附体：飞凤
	[30503186] = 5,	--附体：清羽
...
function x889822_OnActivateOnce( sceneId, selfId )
	...
	if x889822_g_Huanse_PetPossList[itemTblIndex] ==nil then
		x889822_NotifyTip( sceneId, selfId, "物品数据非法")
		return
	end
	local ret = CallScriptFunction(889383, "OnRongHunDanUsed", sceneId, selfId,x889822_g_Huanse_PetPossList[itemTblIndex])
	if ret == 1 then
...
--屏幕中间提示：
--**********************************
function x889822_NotifyTip( sceneId, selfId, Tips)
	BeginEvent( sceneId )
