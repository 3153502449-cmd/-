...
x335134_g_CompoundInfo[980]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10300404, },
	},
}
-- 神器配方表 大夏龙雀1
x335134_g_CompoundInfo[981]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10300405, },
	},
}
-- 神器配方表 大夏龙雀2
x335134_g_CompoundInfo[982]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10300406, },
	},
}
...
x335134_g_CompoundInfo[983]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10302412, },
	},
}
-- 神器配方表 大商尘影1
x335134_g_CompoundInfo[984]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10302413, },
	},
}
-- 神器配方表 大商尘影2
x335134_g_CompoundInfo[985]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10302414, },
	},
}
...
x335134_g_CompoundInfo[986]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303404, },
	},
}
-- 神器配方表 大周岚夜1
x335134_g_CompoundInfo[987]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303405, },
	},
}
-- 神器配方表 大周岚夜2
x335134_g_CompoundInfo[988]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303406, },
	},
}
...
x335134_g_CompoundInfo[989]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301408, },
	},
}
-- 神器配方表 大秦锋镝1
x335134_g_CompoundInfo[990]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301409, },
	},
}
-- 神器配方表 大秦锋镝2
x335134_g_CompoundInfo[991]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301410, },
	},
}
...
x335134_g_CompoundInfo[992]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305408, },
	},
}
-- 神器配方表 大汉弘纲1
x335134_g_CompoundInfo[993]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305409, },
	},
}
-- 神器配方表 大汉弘纲2
x335134_g_CompoundInfo[994]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305410, },
	},
}
...
x335134_g_CompoundInfo[995]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303413, },
	},
}
-- 神器配方表 大晋星痕1
x335134_g_CompoundInfo[996]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303414, },
	},
}
-- 神器配方表 大晋星痕2
x335134_g_CompoundInfo[997]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10303415, },
	},
}
...
x335134_g_CompoundInfo[998]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305418, },
	},
}
...
x335134_g_CompoundInfo[999]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305417, },
	},
}
-- 神器配方表 大隋凝霜2
x335134_g_CompoundInfo[1000]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10305419, },
	},
}
...
x335134_g_CompoundInfo[1001]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301417, },
	},
}
-- 神器配方表 大唐昆岳1
x335134_g_CompoundInfo[1002]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301418, },
	},
}
-- 神器配方表 大唐昆岳2
x335134_g_CompoundInfo[1003]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10301419, },
	},
}
...
x335134_g_CompoundInfo[1004]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10304408, },
	},
}
-- 神器配方表 大宋君岑
x335134_g_CompoundInfo[1005]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10304409, },
	},
}
-- 神器配方表 大宋君岑
x335134_g_CompoundInfo[1006]	= {
	...
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10304410, },
	},
}
----------------------------------------------------------------------------------------
-- 褚少微 2008.5.22 添加7种102级神器
