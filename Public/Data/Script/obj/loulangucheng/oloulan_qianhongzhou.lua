...
x001154_g_strGongGaoInfo = {
  "#P#{_INFOUSR%s}#H经过一番努力，终于收集了材料，大家一起恭喜吧！#{_INFOMSG%s}升级成功！", 
  "#P#{_INFOUSR%s}#H经过一番努力，终于收集了材料，大家一起恭喜吧！#{_INFOMSG%s}升级成功！", 
  "#P#{_INFOUSR%s}#H经过一番努力，终于收集了材料，大家一起恭喜吧！#{_INFOMSG%s}升级成功！", 
  "#P#{_INFOUSR%s}#H经过一番努力，终于收集了材料，大家一起恭喜吧！#{_INFOMSG%s}升级成功！", 
}
	...
	elseif GetNumText() == 1011 then
		...
		c1 = LuaFnGetAvailableItemCount(sceneId, selfId, nStoneId1)
            if c0 >=1 and c1 >=20 then
				BeginEvent( sceneId ) 
					LuaFnDelAvailableItem(sceneId,selfId,10155002,1)--删除物品
					LuaFnDelAvailableItem(sceneId,selfId,20310113,20)--删除物品
