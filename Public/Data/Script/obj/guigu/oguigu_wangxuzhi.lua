...
--所拥有的事件ID列表
--x080001_g_eventList={228908}
x080001_g_eventList={229009,229012,228912}
--x080001_g_eventList={}--201012,201111,201411,201412,201611,201612	,808004	
...
function x080001_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"#{XMPGG_160823_57}")
