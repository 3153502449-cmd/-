...
--所拥有的事件ID列表
x002119_g_eventList={228906}
--x002119_g_eventList={}--201012,201111,201411,201412,201611,201612		
...
function x002119_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"  慕容山庄幽居江南已久，庄内溪流、湖泊不绝，纵眼望去皆是舟船，楼宇寰阁之间花香四溢，江南美景数不胜收。#r    慕容山庄收藏天下武学秘籍已久，庄内的藏书水阁尽是武林中难得一见的典藏。");
