...
function x000030_OnDefaultEvent( sceneId, selfId,targetId )
	...
	if nTime >= 2000 and nTime <= 2100 then
	   SetCharacterTimer( sceneId, selfId, 60000 )
	end
	BeginEvent(sceneId)
	...
	AddNumText( sceneId, x000030_g_scriptId, "帮会与领地介绍", 11, 10 )
		...
		AddNumText(sceneId,x000030_g_scriptId,"帮会工资任务",6,13)
...
function x000030_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if GetNumText() == 13 then
		CallScriptFunction(892002,"Scripttransitcenter",sceneId,selfId,14)
		return
	end
