...
function x000507_OnDefaultEvent( sceneId, selfId,targetId )
	x000507_g_MenPai = GetMenPai(sceneId, selfId)
--	if x000507_g_MenPai == 13 then
		BeginEvent(sceneId)
			AddText(sceneId,"#{THD_190613_11}")
--			AddNumText(sceneId, x000507_g_scriptId, "学习技能",12,0)
--			AddNumText(sceneId, x000507_g_scriptId, "#{MPJJ_XT_110705_01}",11,10)
--			AddNumText(sceneId, x000507_g_scriptId, "#{MPJJ_XT_110705_03}",11,11)
		EndEvent(sceneId)
