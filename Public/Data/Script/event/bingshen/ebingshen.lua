...
x894063_g_BOSSList =
{
	["XiaoYiFeng_NPC"]				= { DataID=15109, Title="疾如风", posX=51, posY=53, Dir=27, BaseAI=3, AIScript=0, ScriptID=894070 },
	["XiaoYiFeng_BOSS"]				= { DataID=15110, Title="疾如风", posX=51, posY=53, Dir=27, BaseAI=27, AIScript=301, ScriptID=894064 },
	...
	["XiaoRuJun_NPC"]		= { DataID=15129, Title="徐如林", posX=173, posY=36, Dir=0, BaseAI=3, AIScript=0, ScriptID=894071 },
	["XiaoRuJun_BOSS"]		= { DataID=15130, Title="徐如林", posX=173, posY=36, Dir=0, BaseAI=27, AIScript=0, ScriptID=894065 },
	["XiaoRuWei_NPC"]		= { DataID=15134, Title="徐如林", posX=173, posY=100, Dir=0, BaseAI=3, AIScript=0, ScriptID=894068 },
	["XiaoRuWei_BOSS"]		= { DataID=15135, Title="徐如林", posX=173, posY=100, Dir=0, BaseAI=27, AIScript=0, ScriptID=894067 },

	["ZhuBai_BOSS"]			= { DataID=15040, Title="外攻防御", posX=169, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=894080 },
	["ZhuHong_BOSS"]			= { DataID=15060, Title="火抗", posX=173, posY=32, Dir=0, BaseAI=28, AIScript=0, ScriptID=894083 },
	["ZhuHuang_BOSS"]			= { DataID=15050, Title="玄抗", posX=177, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=894082 },
	["ZhuLan_BOSS"]			= { DataID=15065, Title="冰抗", posX=176, posY=39, Dir=0, BaseAI=28, AIScript=0, ScriptID=894084 },
	["ZhuLv_BOSS"]			= { DataID=15055, Title="毒抗", posX=170, posY=33, Dir=0, BaseAI=28, AIScript=0, ScriptID=894085 },
	["ZhuZi_BOSS"]			= { DataID=15045, Title="内攻防御", posX=173, posY=38, Dir=0, BaseAI=28, AIScript=0, ScriptID=894081 },

	["Bai_BOSS"]			= { DataID=15140, Title="外攻防御", posX=169, posY=100, Dir=0, BaseAI=28, AIScript=0, ScriptID=894086 },
	["Hong_BOSS"]			= { DataID=15160, Title="火抗", posX=173, posY=97, Dir=0, BaseAI=28, AIScript=0, ScriptID=894089 },
	["Huang_BOSS"]			= { DataID=15150, Title="玄抗", posX=177, posY=98, Dir=0, BaseAI=28, AIScript=0, ScriptID=894088 },
	["Lan_BOSS"]			= { DataID=15165, Title="冰抗", posX=176, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=894090 },
	["Lv_BOSS"]			= { DataID=15155, Title="毒抗", posX=175, posY=104, Dir=0, BaseAI=28, AIScript=0, ScriptID=894091 },
	["Zi_BOSS"]			= { DataID=15145, Title="内攻防御", posX=173, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=894087 },

	["YeLvYan_NPC"]				= { DataID=15174, Title="侵略如火", posX=192, posY=195, Dir=27, BaseAI=3, AIScript=0, ScriptID=894072 },
	["YeLvYanLoss_NPC"]		= { DataID=14216, Title="", posX=117, posY=49, Dir=0, BaseAI=3, AIScript=0, ScriptID=894075 },
	["YeLvYan_BOSS"]			= { DataID=15175, Title="侵略如火", posX=192, posY=195, Dir=27, BaseAI=27, AIScript=0, ScriptID=894066 },
	...
	["LiFan_NPC"]				= { DataID=15189, Title="不动如山", posX=52, posY=203, Dir=27, BaseAI=3, AIScript=0, ScriptID=894075 },
	["YeLvLian_BOSS"]		= { DataID=15190, Title="不动如山", posX=52, posY=203, Dir=27, BaseAI=27, AIScript=0, ScriptID=894069 },
	...
	["TieFuZhen_BOSS"]			= { DataID=15205, Title="", posX=46, posY=196, Dir=0, BaseAI=3, AIScript=0, ScriptID=894094 },
...
{
	["XiaoYiFeng"]			= 8,	--是否可以挑战萧逸风
	["XiaoRuJun"]	= 9,	--是否可以挑战萧如筠
	["YeLvYan"]			= 10,	--是否可以挑战耶律彦
	["ShuangZi"]		= 11,	--是否可以挑战双子....
	["YeLvLian"]		= 12,	--是否可以挑战耶律连城
	["PlayHp"]		= 21,	--玩家血量....
}
...
function x894063_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BroadMsgByChatPipe( sceneId, selfId, "#Y近日，雁门关外传回密报“契丹一族习得奇阵，不日便将南下中原，我朝王土危在旦夕”。#gff00f0胸怀报国之心#gffff00"..nam.."#gff00f0率队在洛阳进入#gffff00兵圣奇阵#gff00f0副本,誓将耶律连城所持#Y征南先锋印#W收入囊中。", 4 )
...
function x894063_OnEnumerate( sceneId, selfId, targetId )
	AddNumText( sceneId, x894063_g_ScriptId, "#{BSQZ_101223_07}", 10, 1 )
end
...
function x894063_CheckCanEnter( sceneId, selfId, targetId )
	...
	for i=0, NearTeamSize-1 do
		...
		if GetLevel( sceneId, PlayerId ) < 85 then
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. "的修为不足85级，还是不要去为妙。"
		return 0, msg
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. "本日已经挑战过3次了。"
		return 0, msg
	end
	return 1
end
...
function x894063_OnCopySceneReady( sceneId, destsceneId )
	...
	for	i=0,nearteammembercount-1 do
		...
		if lastDayCount >= 3 then
			BeginEvent( sceneId )
				AddText( sceneId, "#{BSQZ_101223_12}" )
			EndEvent( sceneId )
			DispatchEventList( sceneId, selfId, targetId )
		return
		end
...
--创建小怪物....
--**********************************
function x894063_CreateSamllDog(sceneId,type)

	if type == 1 then
		for i = 1,37 do
			LuaFnCreateMonster(sceneId,15005,random(68,82), random(90,105), 25, 167, -1 )
		end
	end

	if type == 2 then
		for i = 1,37 do
			LuaFnCreateMonster(sceneId,15025,random(99,110), random(83,95), 25, 167, -1 )
		end
	end

	if type == 3 then
		for i = 1,37 do
			LuaFnCreateMonster(sceneId,15070,random(200,210), random(110,118), 25, 167, -1 )
		end
	end
end