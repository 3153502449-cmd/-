...
x894085_MyName			= "萧如筠"	--自己的名字....
x894085_BrotherName			= "同心竹·绿"	--自己的名字....
...
function x894085_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x894085_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠 所唤 #c2ebeff"..GetName( sceneId, selfId ).." 已被击破，隔岸同色之竹已无法摧毁。" )
