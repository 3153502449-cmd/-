...
x894097_MyName			= "萧如筠"	--自己的名字....
x894097_BrotherName			= "同心竹·白"	--自己的名字....
...
x894097_IDX_CD_SkillH                   = 6	--H技能的CD....
...
function x894097_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894097_g_FuBenScriptId, "TipAllHuman", sceneId, "#H陈勇仁道：萧如筠已施放围困之技，身中林野迷踪状态之人速速远离人群，以免他人一同迷醉山林。" )
...
function x894097_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x894097_g_FuBenScriptId, "TipAllHuman", sceneId, "#{BSQZ_101223_75}" )
