...
x894096_MyName			= "萧如筠"	--自己的名字....
x894096_BrotherName			= "同心竹·白"	--自己的名字....
...
x894096_IDX_CD_SkillH                   = 6	--H技能的CD....
...
function x894096_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠施放的刺竹陷阱生于足下，还请诸位速速躲避。" )
...
function x894096_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠 发动休养生息之术。受同心竹相助，兄弟二人皆已免疫伤害。若能破竹，则对应防御可被免除。" )
...
function x894096_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if impactId == 8813 then
		...
		CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "#H陈勇仁道：兄弟同心，其力断金……由于未在30秒内全灭萧氏弟兄，萧如蔚现已复生……" )
