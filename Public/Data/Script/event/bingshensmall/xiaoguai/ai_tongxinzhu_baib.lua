...
x895086_MyName			= "萧如蔚"	--自己的名字....
x895086_BrotherName			= "同心竹·白"	--自己的名字....
...
function x895086_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x895086_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠 所唤 #c2ebeff"..GetName( sceneId, selfId ).." 已被击破，隔岸同色之竹已无法摧毁。" )
