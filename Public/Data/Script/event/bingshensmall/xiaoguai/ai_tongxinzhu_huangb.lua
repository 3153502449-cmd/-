...
x895088_MyName			= "萧如蔚"	--自己的名字....
x895088_BrotherName			= "同心竹·黄"	--自己的名字....
...
function x895088_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x895088_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠 所唤 #c2ebeff"..GetName( sceneId, selfId ).." 已被击破，隔岸同色之竹已无法摧毁。" )
