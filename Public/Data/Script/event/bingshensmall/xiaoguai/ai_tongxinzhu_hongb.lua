...
--免疫Buff....
x895089_Buff_MianYi1	= 10472	--免疫一些负面效果....
x895089_Buff_MianYi2	= 10471	--免疫普通隐身....
...
x895089_MyName			= "萧如蔚"	--自己的名字....
x895089_BrotherName			= "同心竹·红"	--自己的名字....

--AI Index....
x895089_IDX_KuangBaoMode	= 1	--狂暴模式....0未狂暴 1需要进入狂暴 2已经进入狂暴
x895089_IDX_CD_SkillFH		= 2	--FH技能的CD....
x895089_IDX_CD_SkillG			= 3	--G技能的CD....
x895089_IDX_CD_Talk				= 4	--FH技能喊话的CD....
x895089_IDX_CD_SkillH			= 5	--G技能的CD....

x895089_IDX_CombatFlag 		= 1	--是否处于战斗状态的标志....
...
function x895089_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x895089_g_FuBenScriptId, "TipAllHuman", sceneId, "陈勇仁道： 萧如筠 所唤 #c2ebeff"..GetName( sceneId, selfId ).." 已被击破，隔岸同色之竹已无法摧毁。" )
