...
--	end
	...
	if killedbossnumber >= x050013_g_TotalNeedKillBoss then
		...
		local BodyNum = LuaFnGetCopyScene_HumanCount(sceneId)
	        for i=0, BodyNum-1 do
	            local EveryBody = LuaFnGetCopyScene_HumanObjId( sceneId, i )	  --取得当前场景里人的objId
                SetMissionData(sceneId,EveryBody,FANZEI,1)
			end
	end
