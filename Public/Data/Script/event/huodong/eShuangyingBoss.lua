...
function x808040_OnDefaultEvent( sceneId, actId, iNoticeType, param2, param3, param4, param5 )
	...
	StartOneActivity( sceneId, actId, 1800*1000, iNoticeType )
...
function x808040_CreateABoss()
	...
	if NeedCreate == 1 then 
		...
		local str = format( "#G束河古镇#P天现异象,随着寒光冲突而降,#G霜影#P占领了束河古镇,传闻其携带有珍稀神器重楼材料!" )
...
function x808040_OnPlayerPickUpItemFromShangyingBoss( sceneId, selfId, itemId, bagidx )
	...
	if itemId == 20700001 or itemId == 20700002 or itemId == 20700003 or itemId == 20700004 or itemId == 20700005 then
