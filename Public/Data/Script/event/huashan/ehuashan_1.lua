...
-- 材料奖励
x001230_g_nCailiaoJiangli	 = {{id=20500003,name="3级精铁"},
								{id=20501003,name="3级棉布"},
								{id=20502003,name="3级秘银"},}
...
function x001230_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x001230_g_Update["id01"] then
        ...
        if (nQuarter < 60 or nQuarter >= 62 ) or (nQuarter < 76 or nQuarter >= 78)  then		--报名时间2 4的19:00-19:30，日的15:00-15:30
