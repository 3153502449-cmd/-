...
function x890069_OnDie( sceneId, selfId, killerId )
	...
	local EveryBodyID = LuaFnGetCopyScene_HumanObjId( sceneId, i )	  --取得当前场景里人的objId
		...
		CallScriptFunction(990012, "AddActivePoint",sceneId,EveryBodyID,19,89)
		--====================================
	end
	...
	if playerName ~= nil then
		str = "#H少室山上一阵雷鸣电闪，轰隆隆的雷声从天空传来，原来是#G#{_INFOUSR"..playerName.."}#H带领的队伍正和丁春秋激战。#H激战中，丁春秋一不留神，被一下戳中了死穴，一头栽在地上，倒地不起。"
