...
x890063_g_BOSSList =
{
	["JiuMoZhi_NPC"]				= { DataID=14219, Title="", posX=130, posY=171, Dir=0, BaseAI=3, AIScript=0, ScriptID=890070 },
	["JiuMoZhi_BOSS"]				= { DataID=14247, Title="", posX=130, posY=171, Dir=0, BaseAI=27, AIScript=0, ScriptID=890064 },

	["ZhuangJuXian_NPC"]		= { DataID=14218, Title="", posX=68, posY=121, Dir=0, BaseAI=3, AIScript=0, ScriptID=890071 },
	["ZhuangJuXian_BOSS"]		= { DataID=14242, Title="", posX=68, posY=121, Dir=0, BaseAI=27, AIScript=0, ScriptID=890065 },
	["JiangShi_BOSS"]			= { DataID=14292, Title="", posX=0, posY=0, Dir=0, BaseAI=0, AIScript=0, ScriptID=-1 },

	["MuRongFu_NPC"]				= { DataID=14217, Title="燕王后裔", posX=195, posY=86, Dir=11, BaseAI=3, AIScript=0, ScriptID=890072 },
	["MuRongFu_BOSS"]			= { DataID=14237, Title="燕王后裔", posX=195, posY=86, Dir=11, BaseAI=27, AIScript=0, ScriptID=890066 },

	["YaoBoDang_BOSS"]		= { DataID=14222, Title="凶神", posX=119, posY=46, Dir=0, BaseAI=27, AIScript=0, ScriptID=890067 },
	["SiMaLing_BOSS"]	= { DataID=14227, Title="恶煞", posX=133, posY=46, Dir=0, BaseAI=27, AIScript=0, ScriptID=890068 },

	["YouDanZhi_BOSS"]		= { DataID=14262, Title="", posX=129, posY=126, Dir=0, BaseAI=0, AIScript=0, ScriptID=890074 },

	["LiFan_NPC"]				= { DataID=14208, Title="", posX=126, posY=46, Dir=27, BaseAI=3, AIScript=0, ScriptID=890073 },
	["DingChunQiu_NPC"]		= { DataID=8, Title="少室山室主", posX=117, posY=49, Dir=0, BaseAI=3, AIScript=0, ScriptID=890075 },
	["DingChunQiu_BOSS"]		= { DataID=14232, Title="少室山室主", posX=129, posY=127, Dir=27, BaseAI=27, AIScript=0, ScriptID=890069 },
}
...
function x890063_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x890063_g_ScriptId, "#{CJG_101231_70}", 10, 1 )
...
function x890063_CheckCanEnter( sceneId, selfId, targetId )
	...
	for i=0, NearTeamSize-1 do
		...
		local PlayerId = GetNearTeamMember( sceneId, selfId, i )
		local lastTime = GetMissionData(sceneId,PlayerId, MD_SHAOSHISHAN )
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. "本日已经挑战过1次少室山了。"
		return 0, msg
...
function x890063_OnPlayerEnter( sceneId, selfId )
	...
	--设置挑战过一次缥缈峰....
	local lastTime = GetMissionData(sceneId,selfId, MD_SHAOSHISHAN )
	local lastDayTime = floor( lastTime / 100 )
	local lastDayCount = mod( lastTime, 100 )
	local CurDayTime = GetDayTime()
	...
	SetMissionData(sceneId,selfId, MD_SHAOSHISHAN, lastTime )
--x890063_TipAllHuman( sceneId, "副本将在1秒后关闭。" )
end
